import augmentation, main_student, torch

from torch.utils.data import DataLoader
from custom_dataset import train_loader,test_loader
import faster_rcnn_for_ilod
...
FastRCNN_config = {'output_size' : 7, 'downsample' : 16, 
                   'out_channels' : 4096, 'num_classes' : 16,
...
FastRCNN_Teacher_config = {'output_size' : 7, 'downsample' : 16, 
                   'out_channels' : 4096, 'num_classes' : 16,
                   'bbox_reg_weights' : (10., 10., 5., 5.),
                   'iou_positive_thresh' : 0.5, 'iou_negative_high' : 0.5, 'iou_negative_low' : 0.1,
                   'batch_size_per_image' : 128, 'positive_fraction' : 0.25, 
...
Teacher_TEST_config = {'num_classes' : 16, 'iou_thresh' : 0.5, 'use_07_metric' : True}
...
Teacher_model = faster_rcnn_for_ilod.FasterRCNN(RPN_config, FastRCNN_Teacher_config, gpu_id)

FasterRCNN = main_student.FasterRCNN(RPN_config, FastRCNN_Teacher_config, TRAIN_config, Teacher_TEST_config, DEMO_config, gpu_id)
