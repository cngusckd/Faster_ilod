...
def resize(img, bboxs, min_size, max_size):
    ...
    '''
         min_side가 600이 되도록 종횡비 유지하며 resize, but max_side가 1000을 안넘도록,
        if input image size : ( 353, 500 )
        w, h = 353, 500
        min_side, max_side = 357, 500
        ratio = min( 600/353, 1000/500) => ratio = 600/353  대략 1.6997
        resize_w, resize_h = 353*ratio, 500*ratio == ( 600, 850 )
        이에따라 bbox도 크기변환.
    '''
